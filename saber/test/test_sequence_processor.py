...
@pytest.fixture
def model_no_ds_no_embed(dummy_config_single_ds):
    """Returns an instance of SequenceProcessor initialized with the
    default configuration file and no loaded dataset. """
    model_no_ds_no_embed = SequenceProcessor(config=dummy_config_single_ds)

    return model_no_ds_no_embed

@pytest.fixture
def model_sing_ds_no_embed(dummy_config_single_ds):
    """Returns an instance of SequenceProcessor initialized with the
    default configuration file and a single loaded dataset. """
    model_sing_ds_no_embed = SequenceProcessor(config=dummy_config_single_ds)
    # don't replace rare tokens for the sake of these unit tests
    model_sing_ds_no_embed.load_dataset()

    return model_sing_ds_no_embed

@pytest.fixture
def model_compound_ds_no_embed(dummy_config_compound_ds):
    """Returns an instance of SequenceProcessor initialized with the
    ...
    much simpler."""
    model_compound_ds_no_embed = SequenceProcessor(config=dummy_config_compound_ds)
