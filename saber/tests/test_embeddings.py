...
from .resources.constants import DUMMY_EMBEDDINGS_INDEX
from .resources.constants import DUMMY_EMBEDDINGS_MATRIX
...
class TestEmbeddings(object):
    ...
    def test_prepare_embedding_index(self, dummy_embedding_idx):
    ...
    def test_prepare_embedding_matrix(self, dummy_embedding_matrix_and_type_to_idx):
    ...
    def test_prepare_embedding_matrix_load_all(self,
                                               dummy_embedding_matrix_and_type_to_idx_load_all):
        """Asserts that we get the expected value back after successive calls to
        `Embeddings._prepare_embedding_index()` and
        ...
        # actual values
        embedding_matrix_actual, type_to_idx_actual = \
            dummy_embedding_matrix_and_type_to_idx_load_all

        assert np.allclose(embedding_matrix_actual, embedding_matrix_expected)
        helpers.assert_type_to_idx_as_expected(actual=type_to_idx_actual,
                                               expected=type_to_idx_expected)

    def test_matrix_after_load(self, dummy_embeddings_after_load):
    ...
    def test_matrix_after_load_with_load_all(self, dummy_embeddings_after_load):
        """Asserts that pre-trained token embeddings are loaded correctly when
        `Embeddings.load(load_all=True)` is called."""
        assert np.allclose(dummy_embeddings_after_load.matrix, DUMMY_EMBEDDINGS_MATRIX)

    def test_attributes_after_load(self, dummy_embedding_idx, dummy_embeddings_after_load):
    ...
    def test_attributes_after_load_with_load_all(self,
                                                 dummy_embedding_idx,
    ...
    def test_generate_type_to_idx(self, dummy_embeddings_before_load):
