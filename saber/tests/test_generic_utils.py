...
class TestGenericUtils(object):
    """Collects all unit tests for `saber.utils.generic_utils`.
    """
    ...
    def test_is_consecutive_simple_sorted_list_no_duplicates(self):
    ...
    def test_is_consecutive_simple_unsorted_list_no_duplicates(self):
        """Asserts that `generic_utils.is_consecutive()` returns the expected value when passed a
    ...
    def test_is_consecutive_simple_sorted_list_duplicates(self):
        """Asserts that `generic_utils.is_consecutive()` returns the expected value when passed a
    ...
    def test_is_consecutive_simple_unsorted_list_duplicates(self):
        """Asserts that `generic_utils.is_consecutive()` returns the expected value when passed a
    ...
    def test_is_consecutive_simple_dict_no_duplicates(self):
        """Asserts that `generic_utils.is_consecutive()` returns the expected value when passed a
    ...
    def test_is_consecutive_simple_dict_duplicates(self):
        """Asserts that `generic_utils.is_consecutive()` returns the expected value when passed a
    ...
    def test_reverse_mapping_simple(self):
    ...
    def test_make_dir_new(self, tmpdir):
    ...
    def test_make_dir_exists(self, dummy_dir):
    ...
    def test_clean_path_empty(self):
    ...
    def test_clean_path_simple(self):
    ...
    def test_extract_directory(self, tmp_path):
        ...
        shutil.make_archive(base_name=directory,
                            format='bztar',
                            root_dir=root_dir,
                            base_dir=base_dir)
    ...
    def test_compress_directory_value_error(self):
